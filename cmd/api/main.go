...
import (
	...
	"github.com/jacobgeorge08/greenlight/internal/data"
	"github.com/jacobgeorge08/greenlight/internal/mailer"
	"github.com/jacobgeorge08/greenlight/internal/vcs"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", os.Getenv("MAILTRAP_SENDER"), "SMTP sender")
